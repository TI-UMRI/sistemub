        ...
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="sub open">
            ...
            <ul class="templatemo-submenu">
              ...
              <li><a href="<?=base_url();?>barang_rusak">Barang Rusak</a></li>
          ...
          <li class="sub open">
            ...
            <ul class="templatemo-submenu">
              ...
              <li><a href="<?=base_url();?>daftarlist_barangkeluar">Laporan Data Barang Keluar</a></li>
              <li><a href="<?=base_url();?>daftarlist_barangmasuk">Laporan Data Barang Masuk</a></li>
              <li><a href="<?=base_url();?>daftarlist_barangrusak">Laporan Data Barang Rusak</a></li>
