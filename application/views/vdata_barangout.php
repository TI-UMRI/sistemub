...
<h1><center><b>KELOLA DATA BARANG KELUAR</b></center></h1>
<h4>
    <div class="pull-right">
        <div class="row margin-bottom-30">
            <div class="col-md-12">
              <ul class="nav nav-pills">
                <li class="active"><a href="<?=base_url();?>barang_out/tambah">Tambah Barang</a></li>                
              </ul>
            </div>
        </div>  
    </div>
  ...
  <?php 
        ...
        ?>
                    <tr>
                      ...
                      <td><?=$hasil->tanggal;?></td>
                      <td><a href="<?=base_url();?>barang_out/edit/<?=$hasil->id_out;?>" class="btn btn-warning btn-xs">Edit</a></td>
                      <td><a href="<?=base_url();?>barang_out/hapus/<?=$hasil->id_out;?>" onclik="return confirm('Yakin Akan Menghapus Data?')"class="btn btn-danger btn-xs">Delete</a></td>
                    </tr>
        <?php 
        $i++;
        }
