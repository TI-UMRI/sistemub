          ...
          <div class="row">
            <div class="col-md-12">
              <form role="form" id="templatemo-preferences-form" action="<?=base_url();?>supplier/edit/<?=$kode_supplier;?>" method="post">
  ...
  ?> 
                <div class="row">
                  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="text" class="form-control" id="kode_supplier" name="kode_supplier" value="<?=$hasil->kode_supplier;?>">
                  </div>
                </div>
                <div class="row">  
                  <div class="col-md-6 margin-bottom-15">
                ...
                <div class="row">  
                  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="text" class="form-control" id="alamat_supplier" name="alamat_supplier" value="<?=$hasil->alamat_supplier;?>">
                  </div>
                  </div>
                <div class="row">  
                  <div class="col-md-6 margin-bottom-15">
                    <label for="telp" class="control-label">Telepon</label>
                    <input type="text" class="form-control" id="telp" name="telp" value="<?=$hasil->telp;?>">
                  </div>
                  </div>
                <div class="row">  
                  <div class="col-md-6 margin-bottom-15">
