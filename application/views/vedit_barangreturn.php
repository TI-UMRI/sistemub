          ...
          <div class="row">
            <div class="col-md-12">
              <form role="form" id="templatemo-preferences-form" action="<?=base_url();?>barang_return/edit/<?=$id_return;?>" method="post">
  ...
  ?> 
                <div class="row">
                  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="text" class="form-control" id="id_return" name="id_return" value="<?=$hasil->id_return;?>">
                  </div>
                </div>
                <div class="row">  
                  <div class="col-md-6 margin-bottom-15">
                ...
                <div class="row">  
                  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="text" class="form-control" id="ket" name="ket" value="<?=$hasil->ket;?>">
                  </div>
              </div>  
